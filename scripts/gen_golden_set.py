...
ITEMS: list[tuple[str, str, bool, str, str, str, str]] = [
    ...
    ("niif16-plazo", "niif16", True, "niif16",
    ...
    ("niif16-activo", "niif16", True, "niif16",
    ...
    ("niif16-medicion", "niif16", False, "niif16",
    ...
    ("niif16-exencion", "niif16", False, "niif16",
    ...
    ("niif16-corto-plazo", "niif16", False, "niif16",
    ...
    ("niif16-depreciacion", "niif16", False, "niif16",
    ...
    ("niif16-tasa", "niif16", True, "niif16",
    ...
    ("niif16-remedicion", "niif16", False, "niif16",
    ...
    ("niif15-modelo", "niif15", True, "niif15",
    ...
    ("niif15-obligacion", "niif15", False, "niif15",
    ...
    ("niif15-precio", "niif15", False, "niif15",
    ...
    ("niif15-momento", "niif15", True, "niif15",
    ...
    ("niif15-variable", "niif15", False, "niif15",
    ...
    ("niif15-costos", "niif15", False, "niif15",
    ...
    ("niif15-garantia", "niif15", False, "niif15",
    ...
    ("niif9-clasificacion", "niif9", True, "niif9",
    ...
    ("niif9-deterioro", "niif9", True, "niif9",
    ...
    ("niif9-costo-amortizado", "niif9", False, "niif9",
    ...
    ("niif9-cobertura", "niif9", False, "niif9",
    ...
    ("niif9-valor-razonable", "niif9", False, "niif9",
    ...
    ("niif13-definicion", "niif13", False, "niif13",
    ...
    ("niif13-jerarquia", "niif13", True, "niif13",
    ...
    ("niif13-mercado", "niif13", False, "niif13",
    ...
    ("niif13-tecnicas", "niif13", False, "niif13",
    ...
    ("nia315-riesgo-inherente", "nia315", False, "nia",
    ...
    ("nia315-comprension", "nia315", True, "nia",
    ...
    ("nia315-controles", "nia315", False, "nia",
    ...
    ("nia315-significativo", "nia315", True, "nia",
    ...
    ("nia315-procedimientos", "nia315", False, "nia",
    ...
    ("nia330-respuestas", "nia330", True, "nia",
    ...
    ("nia330-sustantivos", "nia330", False, "nia",
    ...
    ("nia330-controles", "nia330", False, "nia",
    ...
    ("nia330-suficiencia", "nia330", True, "nia",
    ...
    ("niif7-riesgos", "niif7", False, "niif7",
    ...
    ("niif7-liquidez", "niif7", False, "niif7",
    ...
    ("niif7-credito", "niif7", True, "niif7",
    ...
    ("niif7-mercado", "niif7", False, "niif7",
    ...
    ("nic36-indicios", "nic36", False, "nic",
    ...
    ("nic36-recuperable", "nic36", True, "nic",
    ...
    ("nic36-reversion", "nic36", False, "nic",
    ...
    # ── NIC 37 · Provisiones ──────────────────────────────────────────────────
    ("nic37-provision", "nic37", True, "nic",
    ...
    ("nic37-contingente", "nic37", False, "nic",
    ...
    ("nic37-onerosos", "nic37", False, "nic",
    ...
    ("nic37-reembolso", "nic37", False, "nic",
...
def build() -> None:
    ...
    print(f"Generado: {len(ITEMS)} ítems · {n_crit} críticos · {n_niif16} NIIF16 · {len(by_doc)} docs")
